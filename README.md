...
- (Optional) Upload high-school transcripts or a short bio for tailored plans
- Generate a full four-year plan with recommended and alternative courses
- Explain why each recommendation fits (prereqs, sequences, requirements)
- Export a polished, printable PDF to bring to advising counsoler

For high-school students or incoming UH Mānoa students, AlaAI uses natural-language processing for pathway summaries and semantic search for fast retrieval of relevant UH courses. It’s built for speed and customization for students.
