  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-950/80 p-4 backdrop-blur sm:p-6">
      <div className="flex min-h-full items-center justify-center">
        <div className="relative w-full max-w-3xl space-y-6 rounded-3xl border border-slate-800 bg-slate-950/90 p-6 text-slate-100 shadow-2xl sm:p-8">
          <button
            type="button"
            onClick={onCancel}
          ...
          {data && (
            <div className="space-y-6">
              ...
              <div className="max-h-[55vh] space-y-4 overflow-y-auto pr-2 scrollbar-hide">
                {data.years.map((year) => (
                  <article
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:justify-end">
                <button
                  type="button"
                  onClick={onCancel}
                  className="inline-flex items-center justify-center gap-2 rounded-full border border-slate-700 px-5 py-2 text-sm font-semibold uppercase tracking-wide text-slate-300 transition hover:border-slate-500 focus:outline-none focus:ring-2 focus:ring-slate-400/60 focus:ring-offset-2 focus:ring-offset-slate-950"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-full border border-sky-400 px-5 py-2 text-sm font-semibold uppercase tracking-wide text-sky-100 transition hover:bg-sky-400/10 focus:outline-none focus:ring-2 focus:ring-sky-400/60 focus:ring-offset-2 focus:ring-offset-slate-950"
                >
